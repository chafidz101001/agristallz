                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr >
                                            ...
                                            <?php if(isset($_SESSION['email'])) : ?>
                                            <td align="center">
                                                <a href="detailBeli.php?id=<?php echo $id; ?>">detail</a> <br>
                                                ---- <br>
                                                <a href="delBeli.php?id=<?php echo $id; ?>" onclick ="if (!confirm('Apakah Anda yakin akan menghapus data ini?')) return false;">hapus</a>
                                            </td>
                                            <?php endif ?>
                                        </tr>
                                    <?php } ?>
