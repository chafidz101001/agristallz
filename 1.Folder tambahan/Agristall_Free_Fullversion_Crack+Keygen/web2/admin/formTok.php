                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="formTok.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Nama Toko</label>
                                            <input class="form-control" name="namtok" required="">
                                        ...
                                        <input type="submit" class="btn btn-default" name="add_tok" value="Submit">
                                        <button type="reset" class="btn btn-default">Reset</button>
                                    </form>
                                    <?php 
                                    if (isset($_POST['add_tok'])) {
                                      ...
                                      */
                                        ...
                                        $query = "INSERT INTO toko (nama_toko, alamat_toko, kontak, img) VALUES ('$nama', '$alamat', '$kontak', '$imgContent')";
