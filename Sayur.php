		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Buah</h4>
							<p>Terdiri dari buah-buahan tanpa pengawet.</p>
						</div>
					</div>
					<h4>Buah</h4>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Buah Kering</h4>
							<p>Terdiri dari buah-buahan yang sudah dari awalnya kering atau diawetkan.</p>
						</div>
					</div>
					<h4>Buah kering</h4>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Sayur</h4>
							<p>Terdiri darwi sayur-sayuran yang masih segar dan semoga tetap segar.</p>
						</div>
					</div>
					<h4>Sayur</h4>
			...
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_veg">
				...
				<div class="w3ls_w3l_banner_nav_right_grid1 w3ls_w3l_banner_nav_right_grid1_veg">
					...
					<?php 
						$query = "SELECT * FROM barang WHERE kategori = 'Sayur dan Buah'";
